...
#include <U8g2lib.h>
#ifndef __UI_Functions_Cpp__
#define __UI_Functions_Cpp__
...
void SERIAL_UI(void)
{
  ...
  while (Com_selection == 1)
  {
    ...
    // Serial Stuff here
    newData,*receivedChars =recvWithStartEndMarkers(newData,receivedChars,numChars);
    if (newData == true)
    {
    ...
    String TempString0 = String(Xpos); // CONVERT CURRENT A0A POSITION INTO A STRING (Local Variables
    TempString0 += " X Pos";                          // Just adding to the String here
    String TempString1 = String(Ypos); // CONVERT CURRENT A0A POSITION INTO A STRING (Local Variables
    TempString1 += " Y Pos";
    String TempString2 = String(AoA[0] * -1); // CONVERT CURRENT A0A POSITION INTO A STRING (Local Variables
    TempString2 += " AoA Top";
    String TempString3 = String(AoA[1] * -1); // CONVERT CURRENT A0A POSITION INTO A STRING (Local Variables
